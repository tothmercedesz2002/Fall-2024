...
```{r}
# Fitting an updated complex model excluding cortisol_saliva and summarizing the model's statistics

updated_complex_model <- lm(pain ~ age + sex + STAI_trait + pain_cat + mindfulness + cortisol_serum, data = data_filtered)
