...
# Predict survival probabilities for "data_with_Leonardo" using the null model

predictions_with_Leonardo <- predict(null_model, data_with_Leonardo, type = "response")

# Predict survival probabilities for "data_without_Leonardo" using the null model
predictions_without_Leonardo <- predict(null_model, data_without_Leonardo, type = "response")

# Predicted probabilities

predictions_with_Leonardo
predictions_without_Leonardo
```
